...
public class Grok implements Serializable {
  ...
  public void reInit() {
      ...
      this.disco = null;
      this.namedRegex = "";
      this.compiledNamedRegex = null;
      if (this.grokPatternDefinition != null)
        this.grokPatternDefinition.clear();
      else {
        this.grokPatternDefinition = new TreeMap();
      }
      if (this.namedRegexCollection != null)
        this.namedRegexCollection.clear();
      else {
        this.namedRegexCollection = new TreeMap();
      }
      this.savedPattern = "";
  }
